...
export default function Projects() {
    ...
    return (
        ...
        ">
            ...
            flex-wrap
            ">
                <button onClick={() => { setC(data) }} className={c === data ? "btn check" : "btn"}>Abayas</button>
                <button onClick={() => { setC(data2) }} className={c === data2 ? "btn check" : "btn"}>Wedding Dress </button>
                <button onClick={() => { setC(data3) }} className={c === data3 ? "btn check" : "btn"}>Sari </button>
            </div>
            <div initial={{ opacity: 0, x: 130 }}
